...
class LimbahSeeder extends Seeder
{
    ...
    {
        $limbah = [
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A1', 'name' => 'KARDUS'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A2', 'name' => 'PALLET BEKAS (PALLET KAYU)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A3', 'name' => 'PALLET BEKAS (PALLET KARDUS)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A4', 'name' => 'PALLET BEKAS (PALLET PLASTIK)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A5', 'name' => 'KAYU'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A6', 'name' => 'PLASTIK PURGING (PURGING EX PRODUKSI INJ)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A7', 'name' => 'PLASTIK RUNNER (RUNNER EX PRODUKSI INJ)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A8', 'name' => 'LIMBAH DOMESTIK (SAMPAH KANTIN, KANTOR, KERTAS DAUN)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A9', 'name' => 'BOX PLASTIK'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A10', 'name' => 'PART NG PLASTIK (HANDLE DLL)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A12', 'name' => 'PART NG ALUMUNIUM (PART NG ASS UNIT)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A13', 'name' => 'PART NG BESI (HANDLE DLL)'],
            ['code' => '', 'jenis_limbah'=>'sampah', 'kode_internal'=>'A13', 'name' => 'BESI BEKAS (SLEEVE, TROLLY, VALVE)'],
